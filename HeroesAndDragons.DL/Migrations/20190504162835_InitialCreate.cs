        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Created = table.Column<DateTime>(nullable: false),
                    Updated = table.Column<DateTime>(nullable: false),
                    ImpactForce = table.Column<int>(nullable: false),
                    HeroId = table.Column<string>(nullable: false),
                    DragonId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hits", x => x.Id);
                    table.UniqueConstraint("AK_Hits_HeroId_DragonId", x => new { x.HeroId, x.DragonId });
                    table.ForeignKey(
